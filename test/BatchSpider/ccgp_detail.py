...
try:
    ...
    import setting
# 详情页解析
class ccpg_detail_Spider(BatchSpider):
    def __init__(self, **kwargs):
        super(ccpg_detail_Spider, self).__init__(**kwargs)
        self.task_key = "task:ccgp1:detail"  # 需修改
        self.task_table_name = "ccgp1_list"
        self.task_data_table = "ccgp1_detail"
        self.task_batch_table_name = "ccgp1_detail_batch_record"
